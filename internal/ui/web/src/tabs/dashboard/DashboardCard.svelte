...
<div class="flex flex-col max-h-[340px] bg-white dark:bg-lerd-card border border-gray-100 dark:border-lerd-border rounded-xl overflow-hidden {accent[tone]}">
  <div class="shrink-0 flex items-center justify-between gap-3 px-4 py-2.5 border-b border-gray-100 dark:border-lerd-border">
  ...
  {#if footer}
    <div class="shrink-0 px-4 py-2.5 border-t border-gray-100 dark:border-lerd-border">
      {@render footer()}
    </div>
  {/if}
</div>
